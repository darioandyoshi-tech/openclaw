  ...
  if (!runtime) {
    ...
    if (filename.endsWith(".ts")) {
      ...
      const { getCachedPluginModuleLoader } =
        // SAFETY: tsx publishes this typed CJS API; it only bootstraps the local source loader.
        (require("tsx/cjs/api") as typeof import("tsx/cjs/api")).require(
          "../plugins/plugin-module-loader-cache.ts",
          filename,
        ) as typeof import("../plugins/plugin-module-loader-cache.js"); // SAFETY: This fixed local module owns the typed loader export.
